...
_Not yet mapped._ Filled by the Initialization procedure with the project's primary and project-spanning features, following the Feature Map rules above.
